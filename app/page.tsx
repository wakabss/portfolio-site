    ...
    <>
      ...
      >
        ...
        <p>
          ...
          For <em>Tokyo Weekender</em>, I&apos;ve written about{' '}
          <a
        ...
        <p>
          I also do freelance travel writing — which is just a fancy way of saying I&apos;ll go anywhere. I&apos;ve flown to Morocco to meet a stranger,
        ...
        <p>
          ...
          <a
            ...
            style={{ textDecoration: 'underline', color: 'cornflowerblue', fontWeight: 'bold' }}
          >
            email
          </a>{' '}
          or on{' '}
          <a
            ...
            style={{ textDecoration: 'underline', color: 'deeppink', fontWeight: 'bold' }}
          >
            Instagram
          </a>
          !
